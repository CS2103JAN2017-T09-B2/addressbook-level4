...
public class EditCommand extends Command {
    ...
    private static Task createEditedPerson(ReadOnlyTask personToEdit,
        ...
        Time updatedEmail = editPersonDescriptor.getEmail().orElseGet(personToEdit::getEmail);
    ...
    public static class EditPersonDescriptor {
        ...
        private Optional<Time> email = Optional.empty();
        ...
        public void setEmail(Optional<Time> email) {
            assert email != null;
            this.email = email;
        }

        public Optional<Time> getEmail() {
            return email;
        }
